...
void Java_mobi_cangol_mobile_utils_LameUtils_destroyEncoder(
		JNIEnv *env, jobject jobj) {
	int res = lame_close(lame);
	LOGD("Deinit returned: %d", res);
}
void Java_mobi_cangol_mobile_utils_LameUtils_encodeFile(JNIEnv *env,
...
jstring
Java_mobi_cangol_mobile_utils_LameUtils_getSystemABI(JNIEnv *env,
													 jobject thiz) {
#if defined(__arm__)
